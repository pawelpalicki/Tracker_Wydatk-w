// core/api.js — Komunikacja z API backendu
//
// Wrapper fetch z automatycznym tokenem Firebase Auth.

import { auth, IS_DEVELOPMENT, API_BASE_URL } from './config.js';
...
// =====================================================================
// API Z PLIKIEM (BASE64)
// =====================================================================

export async function apiCallWithFile(endpoint, file) {
    const user = auth.currentUser;
    if (!user) {
        logout();
        throw new Error('Użytkownik nie jest zalogowany.');
